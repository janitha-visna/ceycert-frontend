              ...
              {activeAssignment ? (
                <div className="space-y-3">
                  {activeAssignment.assignedUsers.map((user, idx) => (
                    <div
                      key={idx}
                      className="flex items-center space-x-3 bg-white p-3 rounded-lg shadow-sm border border-blue-100"
                    >
                ...
                {historyAssignments.length === 0 ? (
                  ...
                  historyAssignments.map((assignment) => (
                    <div key={assignment.id} className="relative ml-6">
                      <span className="absolute -left-[31px] top-1.5 h-4 w-4 rounded-full border-2 border-white bg-slate-300" />
