...
export const FolderGrid: React.FC<FolderGridProps> = ({
  ...
  const [activeFolderForReminder, setActiveFolderForReminder] =
    useState<string>("");
          ...
          return (
            ...
            >
              ...
              <div className="p-5">
                ...
                <h3 className="text-lg font-semibold text-slate-900 mb-1 group-hover:text-accent transition-colors">
                  {folder.name}
                </h3>
                <div className="flex items-center text-sm text-slate-500 space-x-4 mb-3">
                  <span className="flex items-center">
                    <FileText className="w-4 h-4 mr-1" /> {folder.fileCount}{" "}
                    files
                  </span>
                  <span
