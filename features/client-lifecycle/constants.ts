...
const buildCycle = (
  name: string,
  stages: { name: StageType; folders: string[] }[]
): Cycle => {
  return {
    id: generateId(),
    name: name as any,
...
export const MOCK_AUDIT_DATES: AuditDate[] = [
  {
    cycleName: "Cycle 1",
    stage: "Stage 1",
    plannedDate: "2023-02-10",
    actualDate: "2023-02-12",
    status: "Completed",
  },
  {
    cycleName: "Cycle 1",
...
export const MOCK_ASSIGNMENTS: UserAssignment[] = [
  ...
  {
    id: "a2",
    assignedUsers: [{ name: "David Miller", role: "Lead Auditor" }],
  ...
  {
    id: "a3",
    assignedUsers: [{ name: "Jessica Pearson", role: "Audit Manager" }],
